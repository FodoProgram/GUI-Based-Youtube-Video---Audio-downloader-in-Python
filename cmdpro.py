...
def download_video():
    ...
    try:
        ...
        threading.Thread(target=download_thread, args=(stream, video_folder, video_title)).start()
...
def download_audio():
    ...
    try:
        ...
        threading.Thread(target=download_thread, args=(audio_stream, audio_folder, audio_title)).start()

    except Exception as e:
        messagebox.showerror("Error", str(e))

def download_thread(stream, folder, title):
